...
const levels: LevelConfig[] = [
  {
    ...
    initialItems: [],
    generators: [
      { x: 0, y: 0, defId: 'gen-candle' },  // 烛台 → 长明灯
      { x: 1, y: 0, defId: 'gen-paper' },   // 纸堆 → 血书
      { x: 2, y: 0, defId: 'gen-wood' }     // 木料 → 照妖镜
    ],
    blockedCells: [],
    orders: [
      {
        id: 'order-lamp',
        targetItemId: 'lamp-2',  // 长明灯 Lv.4
        count: 1,
        completed: 0,
